...
echo "Download WSA"
python3 downloadWSA.py "$ARCH" "$RELEASE_TYPE" || python3 downloadWSA.py "$ARCH" "$RELEASE_TYPE" || python3 downloadWSA.py "$ARCH" "$RELEASE_TYPE" || python3 downloadWSA.py "$ARCH" "$RELEASE_TYPE" || python3 downloadWSA.py "$ARCH" "$RELEASE_TYPE"
...
python3 downloadMagisk.py "$ARCH" "$MAGISK_VER" "$WORK_DIR" || python3 downloadMagisk.py "$ARCH" "$MAGISK_VER" "$WORK_DIR" || python3 downloadMagisk.py "$ARCH" "$MAGISK_VER" "$WORK_DIR" || python3 downloadMagisk.py "$ARCH" "$MAGISK_VER" "$WORK_DIR" || python3 downloadMagisk.py "$ARCH" "$MAGISK_VER" "$WORK_DIR" 
echo -e "done\n"
